...
public class PaginaCampo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html>El Estadio Benito Blanco, situado en Lloseta, fue inaugurado el 21 de junio del 2008, como nuevo estadio en donde se disputarian los partidos del primer equipo y en donde se disputan las finales de la Campito Cup. Su nombre esta dedicado a una de las leyendas del club, Benito Blanco, el cual posee el record de goles en el club con 568 goles anotados con la camisa del Campito F.C.</html>");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/trabajofinal/estadioc2.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaginaCampo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaginaCampo().setVisible(true);
            }
        });
    }
